...
current_dir = os.path.dirname(os.path.abspath('resize')) # LEEMOS EL DIRECTORIO EN EL QUE ESTAMOS
...
os.chmod(current_dir + "/peq", 777) # LE DAMOS PERMISO DE ESCRITURA
...
for x in lista_archivos_nopy:
    ...
    if width > heigh: # SI EL ANCHO ES MAYOR QUE EL ALTO (FOTO HORIZONTAL), LO TOMAMOS COMO REFERENCIA
        ...
        img.save(x)  # SALVAMOS LA IMAGEN EN EL DIRECTORIO
